...
Page({
  ...
  charge: debounce(function(e) {
    var itemIndex = parseInt(e.detail.value.input)
    console.log(itemIndex)
    app.globalData.chargeIndex = itemIndex
    if (!this.data.detailData[itemIndex].canStartCharge) {
      return
    }
    ...
    if (userInfo && userInfo.userId) {
      app.$fetch('PRE_CHARGECHECK', {
        sn: this.data.detailData[itemIndex].sn,
        chargeStartWay: "QRCODE",
        operatorId: this.data.detailData[itemIndex].operatorId,
