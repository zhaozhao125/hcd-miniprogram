...
Page({
  ...
  handleCharge() {
    ...
    let chargeIndex = app.globalData.chargeIndex
    console.log(app.globalData.chargeIndex, 'index')
    // 开始充电
    // 修改之前参数
    ...
    app.$fetch('CHARGE_START', {
      sn: chargeDetailData[chargeIndex].sn,
      chargeStartWay: "QRCODE",
      operatorId: chargeDetailData[chargeIndex].operatorId,
      userSn: wx.getStorageSync('userInfo').userId,
      formId: app.globalData.formId
    }, {
      loading: false,
